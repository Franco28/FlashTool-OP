...
public class OPENVisual5T extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setTitle("OnePlus 5T Tool - BETA En - 1.0.0.8-RC1");
        ...
        MenuItemDownloadFirmware.setText("Download last OxygenOS One Plus 5T");
...
try {
    ...
    DebugConsole.setText("Welcome to OnePlus 5T Tool");
...
try {
    ...
    final File file = new File("C:\\OPTool\\.settings\\bin\\recovery.bat");
        ...
        try (PrintWriter writer = new PrintWriter(file, "UTF-8")) {
            ...
            writer.println("color C");
            writer.println("echo.");
            writer.println("echo Flash twrp-3.3.1-20190908-0-codeworkx-signed-forcedecrypt-dumpling for OP5T...");
            writer.println("echo.");
            writer.println("echo Press any key to continue...");
            writer.println("pause>nul");
...
try {
    ...
    private void MenuItemDownloadFirmwareActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MenuItemDownloadFirmwareActionPerformed
        ...
        jProgressBar.setStringPainted(true);
        jProgressBar.setString("Starting...");
        JFrame frame = new JFrame("Downloading OnePlus5TOxygen_43_OTA_051_all_1907311840_e8c04786be484869....");
        frame.setContentPane(jProgressBar);
        frame.setDefaultCloseOperation(WindowConstants.DO_NOTHING_ON_CLOSE);
        frame.setSize(600, 100);
        frame.setVisible(true);
        ...
        Runnable updatethread;
                ...
                try (final java.io.BufferedInputStream in = new java.io.BufferedInputStream(httpConnection.getInputStream())) {
                    ...
                    try (final java.io.BufferedOutputStream bout = new BufferedOutputStream(fos, 1024)) {
                        ...
                        while ((x1 = in.read(data, 0, 1024)) >= 0) {
                            ...
                            jProgressBar.setString("Calculating file size...");
                            SwingUtilities.invokeLater(() -> {
                                DebugConsole.setText("Downloading OnePlus5TOxygen_43_OTA_051_all_1907311840_e8c04786be484869..." +currentProgress+ " Bytes");
                                jProgressBar.setString("Downloading OnePlus5TOxygen_43_OTA_051_all_1907311840_e8c04786be484869: \n" +currentProgress+ " Bytes");
                                jProgressBar.setValue(currentProgress);
                            });
                            bout.write(data, 0, x1);
                        }
            ...
            jProgressBar.setString("Downloading OnePlus5TOxygen_43_OTA_051_all_1907311840_e8c04786be484869: ERROR");
            DebugConsole.setText("ERROR: " +e);
            }catch (IOException ex) {
                Logger.getLogger(OPVisual.class.getName()).log(Level.SEVERE, null, ex);
            }
