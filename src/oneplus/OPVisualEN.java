...
public class OPVisualEN extends javax.swing.JFrame {
       
    /**
     * Creates new form OPVisualEN
     */
    public OPVisualEN() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        MenuItemOpenROM.setText("Open ROM folder");
        ...
        xdarom.setText("List of Official ROMS");
        ...
        MenuItemEnglish.setIcon(new javax.swing.ImageIcon(getClass().getResource("/oneplus/images/spanish-language.png"))); // NOI18N
        MenuItemEnglish.setText("Español");
  ...
  DebugConsole.setText("Error: " + e.getMessage());     
        ...
        try {
            ...
            DebugConsole.setText("ERROR: " +e);
                ...
                if (runnable != null) runnable.run();
                Logger.getLogger(OPVisualEN.class.getName()).log(Level.SEVERE, null, ex);
            }
        };
        ...
        File bin = new File("C:\\OPTool\\.settings\\lib\\OnePlus.jar"); 
        if (!bin.exists() == true){
        final Runnable runnable = (Runnable) Toolkit.getDefaultToolkit().getDesktopProperty("win.sound.exclamation");
        if (runnable != null) runnable.run();
...
try {
    ...
    final File file = new File("C:\\OPTool\\.settings\\bin\\recovery.bat");
        ...
        try (PrintWriter writer = new PrintWriter(file, "UTF-8")) {
            ...
            writer.println("color C");
            writer.println("echo.");
            writer.println("echo Flashear twrp-3.3.1-20190908-0-codeworkx-signed-forcedecrypt-cheeseburger for OP5...");
            writer.println("echo.");
            writer.println("echo Pulse cualquier tecla para continuar...");
            writer.println("pause>nul");
...
try {
    ...
    private void MenuItemChangelogActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MenuItemChangelogActionPerformed
        ...
        try (PrintWriter writer = new PrintWriter(file, "UTF-8")) {
            ...
            writer.println("echo ***************"); 
            writer.println("echo - Agregado Drivers de OnePlus");
            writer.println("echo - Arreglado -adb- no se puede instalar debido a error en el codigo");
            writer.println("echo - Anadido motor de lenguaje y sistema operativo");
            writer.println("echo - Arreglado OP5 ingles Tool");
            writer.println("echo.");            
            writer.println("echo Presiona cualquier tecla para salir...");
            writer.println("echo.");
            writer.println("pause>nul");
...
try {
    ...
    if(oos.exists() == true || ooos.exists() == true){   
        ...
        JOptionPane.showMessageDialog(null,"El tamaño del archivo descargado es de: " +fileSize+ " Bytes \n\n Tamaño del archivo original en Bytes: 1.907.085.197 \n\n Si estos no coinciden por favor descarga de nuevo el arhcivo","Cuidado! Lea atentamente antes de continuar",JOptionPane.WARNING_MESSAGE);
    ...
    if (reply2 == JOptionPane.YES_OPTION) {   
       Desktop desktop = Desktop.getDesktop();
        ...
        try (PrintWriter writer = new PrintWriter(file, "UTF-8")) {
            ...
            writer.println("echo Reiniciar Recovery...");
            writer.println("echo.");
            writer.println("echo Presiona cualquier tecla para contiunar...");
            writer.println("pause>nul");
            writer.println("echo.");
            writer.println("adb reboot recovery");
            writer.println("echo.");
...
// automatically created
 try{
  ...
  DebugConsole.setText("Error: " + e.getMessage());     
    ...
    File romm = new File("C:\\OPTool\\rom\\pe\\PixelExperience_Plus_cheeseburger-9.0-20190908-1605-OFFICIAL.zip"); 
        ...
        frame.setLocationRelativeTo(null); 
        if(!frame.isVisible()) {
        JOptionPane.showMessageDialog(null,"Descarga cancelada","Error",JOptionPane.INFORMATION_MESSAGE);
        this.dispose();//To close the current window        
        new OPVisualEN().setVisible(true);
        }
        Runnable updatethread;
            updatethread = () -> {
            try {
                URL url = new URL("https://get.pixelexperience.org/get_file/OTYrRVpuWjlzSFBXZHNyaVkwdHRDV2lXM2ErQjMxcGE0Uy9BSjZjS1hueHplcHl5RC96WEttZGtLRDVzR2dSNGo4TndKSFpEZnQrR09zVGU5eHZQanVIYzVvT3lrcFR2blpXYmVEcGdxVHFxTjBDOUYwUXNMd1VCWUlXYkc0WU1uNkVHVUd0dDF3YWxGdW5hYlEyaHlQc0tCcjF2UTFXTVkrcHJyODlzQnhzPQ==/");
                HttpURLConnection httpConnection = (HttpURLConnection) (url.openConnection());
                long completeFileSize = httpConnection.getContentLength();
                try (final java.io.BufferedInputStream in = new java.io.BufferedInputStream(httpConnection.getInputStream())) {
...
// automatically created
 try{
  ...
  DebugConsole.setText("Error: " + e.getMessage());     
        ...
        File lineageoss = new File("C:\\OPTool\\rom\\los\\lineage-16.0-20190912-nightly-cheeseburger-signed.zip"); 
        
        if(lineageoss.exists()){
        Desktop desktop = Desktop.getDesktop();
        File dirToOpen = null;
        try {
...
// automatically created
 try{
  ...
  DebugConsole.setText("Error: " + e.getMessage());     
        ...
        File lineageoss = new File("C:\\OPTool\\rom\\du\\du_cheeseburger-v13.5-20190809-1211-OFFICIAL.zip"); 
...
// automatically created
 try{
  ...
  DebugConsole.setText("Error: " + e.getMessage());     
       ...
       File romm = new File("C:\\OPTool\\rom\\carbon\\CARBON-CR-7.0-OPAL-WEEKLY-cheeseburger-20190911-0306.zip"); 
...
// automatically created
 try{
  ...
  DebugConsole.setText("Error: " + e.getMessage());     
        ...
        File lineageoss = new File("C:\\OPTool\\rom\\arrow\\Arrow-v9.0-cheeseburger-OFFICIAL-20190830.zip"); 
...
// automatically created
 try{
  ...
  DebugConsole.setText("Error: " + e.getMessage());     
        ...
        File lineageoss = new File("C:\\OPTool\\rom\\crdroid\\crDroidAndroid-9.0-20190903-cheeseburger-v5.7.zip"); 
...
// automatically created
 try{
  ...
  DebugConsole.setText("Error: " + e.getMessage());     
        ...
        File lineageoss = new File("C:\\OPTool\\rom\\bliss\\Bliss-v11.9-cheeseburger-OFFICIAL-20190828.zip"); 
...
// automatically created
 try{
  ...
  DebugConsole.setText("Error: " + e.getMessage());     
        ...
        File lineageoss = new File("C:\\OPTool\\rom\\validus\\Gzosp-cheeseburger-9.Stable.2.1-Official-20190819-1157.zip"); 
...
// automatically created
 try{
  ...
  DebugConsole.setText("Error: " + e.getMessage());     
        ...
        File lineageoss = new File("C:\\OPTool\\rom\\aicp\\aicp_cheeseburger_p-14.0-WEEKLY-20190902.zip"); 
        
        if(lineageoss.exists()){
        Desktop desktop = Desktop.getDesktop();
        File dirToOpen = null;
        try {
            dirToOpen = new File("C:\\OPTool\\rom\\aicp");
            desktop.open(dirToOpen);
        } catch (IllegalArgumentException iae) {
            if (runnable != null) runnable.run();
            JOptionPane.showMessageDialog(null,"Carpeta " +dirToOpen+ "no encontrada","Error",JOptionPane.ERROR_MESSAGE);
...
// automatically created
 try{
  ...
  DebugConsole.setText("Error: " + e.getMessage());     
        ...
        File lineageoss = new File("C:\\OPTool\\rom\\omni\\omni-9-20190908-oneplus5-WEEKLY.zip"); 
...
try {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(OPVisualEN.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
        //</editor-fold>
