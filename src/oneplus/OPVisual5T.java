...
public class OPVisual5T extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setTitle("OnePlus 5T Tool - BETA Es - 1.0.0.8-RC1");
        ...
        MenuItemDownloadFirmware.setText("Descargar última OxygenOS One Plus 5T");
        ...
        MenuItemOP5Tool.setText("OnePlus 5 Tool");
        ...
        getAccessibleContext().setAccessibleDescription("Tool for OnePlus 5T");
...
try {
    ...
    DebugConsole.setText("Bienvenido a OnePlus 5T Tool");
...
try {
    ...
    private void FlashTWRPOxygenOSBTNActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_FlashTWRPOxygenOSBTNActionPerformed
        ...
        File f = new File("C:\\OPTool\\img\\recovery\\twrp-3.3.1-20190908-0-codeworkx-signed-forcedecrypt-dumpling.img"); 
        ...
        Runnable updatethread;
            updatethread = () -> {
            try {
                URL url = new URL("https://ufpr.dl.sourceforge.net/project/cheeseburgerdumplings/16.0/dumpling/recovery/twrp-3.3.1-20190908-0-codeworkx-signed-forcedecrypt-dumpling.img");
                HttpURLConnection httpConnection = (HttpURLConnection) (url.openConnection());
                long completeFileSize = httpConnection.getContentLength();
                try (final java.io.BufferedInputStream in = new java.io.BufferedInputStream(httpConnection.getInputStream())) {
                    java.io.FileOutputStream fos = new java.io.FileOutputStream("C:\\OPTool\\img\\recovery\\twrp-3.3.1-20190908-0-codeworkx-signed-forcedecrypt-dumpling.img");
                    try (final java.io.BufferedOutputStream bout = new BufferedOutputStream(fos, 1024)) {
                        byte[] data = new byte[1024];
                        long downloadedFileSize = 0;
                        int x1 = 0;
    ...
    File of = new File("C:\\OPTool\\img\\recovery\\twrp-3.3.1-20190908-0-codeworkx-signed-forcedecrypt-dumpling.img");
    ...
    final File file = new File("C:\\OPTool\\.settings\\bin\\recovery.bat");
        ...
        try (PrintWriter writer = new PrintWriter(file, "UTF-8")) {
            ...
            writer.println("color C");
            writer.println("echo.");
            writer.println("echo Flashear twrp-3.3.1-20190908-0-codeworkx-signed-forcedecrypt-dumpling for OP5T...");
            writer.println("echo.");
            writer.println("echo Pulse cualquier tecla para continuar...");
            writer.println("pause>nul");
            writer.println("cd C:\\OPTool\\img\\recovery");
            writer.println("echo.");
            writer.println("fastboot flash recovery twrp-3.3.1-20190908-0-codeworkx-signed-forcedecrypt-dumpling.img");
            writer.println("echo.");
            writer.println("echo Presiona cualquier tecla para salir...");
            writer.println("echo.");
            writer.println("pause>nul");
...
try {
    ...
    private void MenuItemDownloadFirmwareActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MenuItemDownloadFirmwareActionPerformed
        ...
        File f = new File("C:\\OPTool\\img\\firmware\\OnePlus5TOxygen_43_OTA_051_all_1907311840_e8c04786be484869.zip"); 
        ...
        jProgressBar.setStringPainted(true);
        jProgressBar.setString("Iniciando...");
        JFrame frame = new JFrame("Descargando OnePlus5TOxygen_43_OTA_051_all_1907311840_e8c04786be484869....");
        frame.setContentPane(jProgressBar);
        frame.setDefaultCloseOperation(WindowConstants.DO_NOTHING_ON_CLOSE);
        frame.setSize(600, 100);
        frame.setVisible(true);
        ...
        Runnable updatethread;
            updatethread = () -> {
            try {
                URL url = new URL("https://oxygenos.oneplus.net/OnePlus5TOxygen_43_OTA_051_all_1907311840_e8c04786be484869.zip");
                HttpURLConnection httpConnection = (HttpURLConnection) (url.openConnection());
                long completeFileSize = httpConnection.getContentLength();
                try (final java.io.BufferedInputStream in = new java.io.BufferedInputStream(httpConnection.getInputStream())) {
                    java.io.FileOutputStream fos = new java.io.FileOutputStream("C:\\OPTool\\img\\firmware\\OnePlus5TOxygen_43_OTA_051_all_1907311840_e8c04786be484869.zip");
                    try (final java.io.BufferedOutputStream bout = new BufferedOutputStream(fos, 1024)) {
                        byte[] data = new byte[1024];
                        long downloadedFileSize = 0;
                        int x1 = 0;
                        while ((x1 = in.read(data, 0, 1024)) >= 0) {
                            ...
                            jProgressBar.setString("Calculando tamaño del archivo...");
                            SwingUtilities.invokeLater(() -> {
                                DebugConsole.setText("Descargando OnePlus5TOxygen_43_OTA_051_all_1907311840_e8c04786be484869..." +currentProgress+ " Bytes");
                                jProgressBar.setString("Descargando OnePlus5TOxygen_43_OTA_051_all_1907311840_e8c04786be484869: \n" +currentProgress+ " Bytes");
                                jProgressBar.setValue(currentProgress);
                            });
                            bout.write(data, 0, x1);
                        }
            ...
            jProgressBar.setString("Descargando OnePlus5TOxygen_43_OTA_051_all_1907311840_e8c04786be484869: ERROR");
            DebugConsole.setText("ERROR: " +e);
            }catch (IOException ex) {
                Logger.getLogger(OPVisual.class.getName()).log(Level.SEVERE, null, ex);
            }
